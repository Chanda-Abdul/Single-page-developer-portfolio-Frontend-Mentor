...
const links = [
  {
    linkTo: 'GitHub',
    svg: '/assets/images/icon-github.svg',
    width: '25',
    height: '24',
    ...
    link: 'https://github.com/Chanda-Abdul/',
  },
  {
    linkTo: 'Frontend Mentor',
    svg: '/assets/images/icon-frontend-mentor.svg',
    width: '26',
    height: '23',
    ...
    link: 'https://www.frontendmentor.io/profile/Chanda-Abdul',
  },
  {
    linkTo: 'LinkedIn',
  ...
  {
    linkTo: 'Twitter',
    svg: '/assets/images/icon-twitter.svg',
    width: '24',
    height: '20',
...
function renderLinkIcon(linkData) {
  /**
   * Creates svg that can be styled with css.
   * @param {object} linkData that should include
   * @param {d} @param {width} @param {height}
  ...
  iconSvg.setAttribute('width', linkData.width);
  iconSvg.setAttribute('height', linkData.height);
  iconSvg.classList.add('link_icon');
  iconPath.setAttribute('d', linkData.d);
  iconSvg.appendChild(iconPath);

  return iconSvg;
}

let listForSocialIconsinHeader = document.getElementById('links_header');
let listForSocialIconsinFooter = document.getElementById('links_footer');
...
appendListWithSocialIcons(listForSocialIconsinHeader);
appendListWithSocialIcons(listForSocialIconsinFooter);
